...
const SignIn = () => {
  ...
  const [acceptTerms, setAgreeTerms] = useState(false);
    ...
    <div className="SignUpForm">
      {isDesktop ? (
        ...
        >
          <div className="SignInContainer">
            <div className="SignInNow">
              <div className="DesktopLogoSignIn">
                <img
                  src={DesktopColorLogo}
                  alt="desktop color logo"
                  style={{ width: "25%", margin: "2em 1em 2em 8em" }}
                />
              </div>
              <div className="DesktopSignInText">
                <h1>
                  Have all your business finances in one place, to stay on top
                  of your business result.
                </h1>
              </div>
          ...
          <div
            className="SignInFormArea"
            style={{ padding: "3em 7em", height: "100vh" }}
          >
      ...
      <h5>Already have an account? <span style={{fontWeight:"bold", cursor:"pointer"}} onClick={LogClick}> Log in</span></h5>
          ...
          <div
            ...
            style={{ position: "absolute", top: "150px", paddingRight: "1em" }}
          >
            <TextField
              label="First Name"
              value={firstName}
          ...
          <div>
            <img
              src={BlueEllipse}
              alt="footer circle"
              style={{ position: "relative", top: "200px", left: "-20px" }}
            />
          </div>
        </div>
      )}
